...
- **BİZİM ÖLÇMƏMİZ BUNU TƏSDİQLƏMƏDİ (AP-017, 2026-09-01).** Yuxarıdakı 39% rəqəmi **sitat olaraq qalır** — mənbəsi güclüdür və biz onu təkzib etmirik. Amma öz deqradasiya əyrimizdə (5 ailə × 1/3/5/8 növbə, faktlar həmişə 1-ci mesajda, sual həmişə sonda, yalnız **məsafə** dəyişir) **ölçülən 3 ailədə 8 növbəyə qədər deqradasiya tapılmadı**: `t01` ailəsinin 12 saxlanmış cavabının **hamısı** düzgün verdikt verdi. Xam çıxışdakı «t8-də 33% düşmə» tamamilə **bizim `REJECT` iynəmizin boşluğundan** gəlirdi (A-27); düzəlişdən sonra t8 2/3 → 3/3 oldu. Qalan t3 uğursuzluğu da iynənin idi — markdown vurğusu (A-28); qrader qatında bağlandıqdan sonra ailə **12/12**-dir. Fərq metoddadır və gizlədilmir: **bizim doldurucularımız məzmunsuzdur — biz *məsafəni* ölçdük, Laban və b. *natamam spesifikasiyanı* (sharded prompt) ölçdü.** Bu, eyni test deyil, ona görə 39% ilə ədədi müqayisə **aparılmır**. Düzgün formulyasiya: rejim bizim şəraitimizdə (bir model, bir platforma, bir korpus, maksimum 8 növbə, 3 ailə) **təkrarlanmadı**. Detallar: `FINDINGS.md` §4-A · `evals/datasets/COVERAGE.md` §12 · `docs/LIMITATIONS.md` `LIM-C04`.
...
**FAKTİKİ İCRA — bu bənddən DARDIR (AP-017).** Qurulan əyri sharded prompt DEYİL: faktlar həmişə **1-ci mesajda** tam verilir, aradakı növbələr **məzmunsuz doldurucudur** və yalnız fakt→sual **məsafəsi** dəyişir (0/2/4/7). Yəni ölçdüyümüz ölçü **məsafədir**, Laban və b.-nin ölçdüyü **natamam spesifikasiya** deyil; **bərpa testi isə ümumiyyətlə qurulmayıb**. Bu fərq nəticəyə birbaşa təsir edir və gizlədilmir — ona görə ölçmə nəticəmiz ilə 39% arasında ədədi müqayisə aparıla bilməz. Bax: `FINDINGS.md` §4-A · `docs/LIMITATIONS.md` `LIM-C04`.
